 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.hangmanv2.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.hangmanv2'; // ios bundle id
const PACKAGE = 'com.hangmanv2'; // android package name
const NAME = 'HangmanV2'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'HangmanV2'; // app scheme
